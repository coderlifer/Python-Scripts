...
#####################################################################################
# read data from file
# examples: just like 'my_data'
# attributes: the attribute of each column represent, 
# looks like: ['Referrer', 'Location', 'Read FAQ', 'Pages viewed', 'Service chosen']
# So, your data should be like: [['Referrer', 'Location', 'Read FAQ', 'Pages viewed', 'Service chosen'],
...
# you can execute the command in shell: python treepredict.py your-training-dataset.csv your-testing-dataset.csv
